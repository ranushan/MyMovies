...
public class ReleaseDatesController {
	...
	@RequestMapping(value = "/data/{movie_id}/release_dates", method = RequestMethod.GET, produces = "application/json")
	@ResponseBody
	public Release_DatesDTO getAPI_Release_Dates(@PathVariable String movie_id) {
		...
		//System.out.println(release_Dates.toString());
